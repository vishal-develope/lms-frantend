    ...
    return (
        <div className="card">
            ...
            <div className="list-group list-group-flush">
                ...
                <Link to="/favorite-course" className="list-group-item list-group-item-action">Favorite Courses</Link>
                <Link to="/recommended-course" className="list-group-item list-group-item-action">Recommended Courses</Link>
